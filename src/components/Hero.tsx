        ...
        <div className="relative z-10 w-full h-full flex flex-col">
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center px-4 md:px-8 max-w-4xl mx-auto">
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-5xl md:text-6xl lg:text-[80px] font-normal text-[#fef6e9] mb-2 tracking-tight leading-[1.05]"
            >
              Fluid Asset Streams
            </motion.h1>
            <motion.p
              ...
              className="text-sm sm:text-base md:text-lg text-[#fef6e9] opacity-80 leading-relaxed max-w-xl font-normal"
            >
