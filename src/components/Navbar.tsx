...
export default function Navbar() {
  return (
    <nav className="absolute top-0 left-0 right-0 z-20 flex items-center justify-between px-4 md:px-8 lg:px-12 py-4 md:py-6">
      ...
      {/* Center menu */}
      <ul className="hidden md:flex items-center gap-8 bg-white/40 backdrop-blur-md border border-white/30 rounded-full px-6 py-2.5 text-[14px] font-normal text-[#790002]">
        {items.map((item) => (
          <li
            key={item.label}
